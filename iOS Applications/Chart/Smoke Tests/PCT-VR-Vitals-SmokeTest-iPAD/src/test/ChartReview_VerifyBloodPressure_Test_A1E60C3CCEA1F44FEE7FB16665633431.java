...
public class ChartReview_VerifyBloodPressure_Test_A1E60C3CCEA1F44FEE7FB16665633431 extends LTTestScript  {
...
pa.addPA("com.ibm.rational.test.lt.execution.moeb.dc.MoebDataAdapter", "com.ibm.rational.test.lt.execution.moeb.action.MoebStepBatchAction");
	...
	public ChartReview_VerifyBloodPressure_Test_A1E60C3CCEA1F44FEE7FB16665633431(IContainer container, String invocationId) {
		super(container, "ChartReview_VerifyBloodPressure", invocationId, "A1E60C3CCEA1F44FEE7FB16665633431");
		setArmEnabled(false);
...
this.addEventBehavior(new RPTEventStructure(new RPTFailVPEvent(), new RPTContinueEvent("Content Verification Point failed"), 1, "Content Verification Point failed"));
	...
	this.add(applicationContext_1(this));
			this.addFinally(new EndMoebStepBatchAction(this));
		     ...
		     log("Test Execution: ChartReview_VerifyBloodPressure_Test_A1E60C3CCEA1F44FEE7FB16665633431 ",e);
	    } finally {
	        super.execute();
		}	    
    }
	...
	VariableAction vc = new VariableAction(parent, "", "A1E5E072C2BA971EE43DB13337353663");	
			vars[0] = new DataVar("Var_BP_Systolic_Value", null, IDataArea.VIRTUALUSER, "WARNING", false, false);

	
		vars[1] = new DataVar("Var_BP_Diastolic_Value", null, IDataArea.VIRTUALUSER, "WARNING", false, false);

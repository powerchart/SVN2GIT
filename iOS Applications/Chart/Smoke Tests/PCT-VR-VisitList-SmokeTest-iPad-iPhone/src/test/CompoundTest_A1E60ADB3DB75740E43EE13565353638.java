...
public class CompoundTest_A1E60ADB3DB75740E43EE13565353638 extends
		com.ibm.rational.test.lt.kernel.action.impl.CompoundTest {

	public CompoundTest_A1E60ADB3DB75740E43EE13565353638(IContainer parent,
			String name) {
		super(parent, "PCT-VR-VisitList-SmokeTest-iPad",
	...
	public void execute() {
		...
		IContainer testMethod_1 = (IContainer) loadTest(
				...
				"A1E60D472F18C390E43EE13565353638");
		...
		IContainer testMethod_3 = (IContainer) loadTest(
				...
				"A1E60D47D5723690E43EE13565353638");

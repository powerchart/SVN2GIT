...
public class AddMultumAllergyWithClinicalInteraction_SplitScreen_Test_A1E5F02009B4ED26FB5EB16565353433 extends LTTestScript  {
...
pa.addPA("com.ibm.rational.test.lt.execution.moeb.dc.MoebDataAdapter", "com.ibm.rational.test.lt.execution.moeb.action.MoebStepBatchAction");
	...
	public AddMultumAllergyWithClinicalInteraction_SplitScreen_Test_A1E5F02009B4ED26FB5EB16565353433(IContainer container, String invocationId) {
		super(container, "AddMultumAllergyWithClinicalInteraction_SplitScreen", invocationId, "A1E5F02009B4ED26FB5EB16565353433");
		setArmEnabled(false);
...
this.addEventBehavior(new RPTEventStructure(new RPTFailVPEvent(), new RPTContinueEvent("Content Verification Point failed"), 1, "Content Verification Point failed"));
	...
	this.add(applicationContext_4(this));
			this.addFinally(new EndMoebStepBatchAction(this));
		     ...
		     log("Test Execution: AddMultumAllergyWithClinicalInteraction_SplitScreen_Test_A1E5F02009B4ED26FB5EB16565353433 ",e);
	    } finally {
	        super.execute();
		}	    
    }
	...
	VariableAction vc = new VariableAction(parent, "", "A1E5E4EE98B3126EC2FBE33863643632");	
			vars[0] = new DataVar("Var_MultumAllergy_InteractionBanner", "acetaminophen", IDataArea.VIRTUALUSER, "IGNORE", false, false);

	
		vars[1] = new DataVar("Var_AllergyMultumComments", "comments added ", IDataArea.VIRTUALUSER, "IGNORE", false, false);

	
		vars[2] = new DataVar("Var_InteractionOrder", "Interaction with the following order:", IDataArea.VIRTUALUSER, "IGNORE", false, false);
	...
	ISubRule sub_2 = new SubRule("MOEB_FIELD/TPM:A1E5E4EEAD407470C2FBE33863643632", 0, 15, false, (IDCCoreVar)vars[1], false, "Adding Comments", null, 0, false);

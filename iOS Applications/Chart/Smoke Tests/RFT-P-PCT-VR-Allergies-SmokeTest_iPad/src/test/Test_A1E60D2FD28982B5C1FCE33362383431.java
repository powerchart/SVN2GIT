...
public class Test_A1E60D2FD28982B5C1FCE33362383431 extends LTTestScript  {
...
pa.addPA("com.ibm.rational.test.lt.execution.moeb.dc.MoebDataAdapter", "com.ibm.rational.test.lt.execution.moeb.action.MoebStepBatchAction");
	...
	public Test_A1E60D2FD28982B5C1FCE33362383431(IContainer container, String invocationId) {
		super(container, "Allergy_SplitScreen_Click_OnAllergy-H", invocationId, "A1E60D2FD28982B5C1FCE33362383431");
		setArmEnabled(false);
...
this.addEventBehavior(new RPTEventStructure(new RPTFailVPEvent(), new RPTContinueEvent("Content Verification Point failed"), 1, "Content Verification Point failed"));
	...
	this.add(varAction_1(this));
		KDelay delay_1 = new KDelay(this, "Delay (20 sec.)", "A1E60DE83BA0DA70C1FCE33362383431", 20, 1000);
		this.add(delay_1);
	...
	this.add(applicationContext_1(this));
			this.addFinally(new EndMoebStepBatchAction(this));
		     ...
		     log("Test Execution: Test_A1E60D2FD28982B5C1FCE33362383431 ",e);
	    } finally {
	        super.execute();
		}	    
    }
...
private VariableAction varAction_1(final IContainer parent) {
	...
	VariableAction vc = new VariableAction(parent, "", "A1E5E9C455FB42F3C2FBE33863643632");	
			vars[0] = new DataVar("Var_Allergy_H", "Free Text Allergy", IDataArea.VIRTUALUSER, "IGNORE", false, false);

...
public class AddMultumAllergy_SplitScreen_Test_A1E5EFF94C5E46A5C2FBE33863643632 extends LTTestScript  {
...
pa.addPA("com.ibm.rational.test.lt.execution.moeb.dc.MoebDataAdapter", "com.ibm.rational.test.lt.execution.moeb.action.MoebStepBatchAction");
	...
	public AddMultumAllergy_SplitScreen_Test_A1E5EFF94C5E46A5C2FBE33863643632(IContainer container, String invocationId) {
		super(container, "AddMultumAllergy_SplitScreen", invocationId, "A1E5EFF94C5E46A5C2FBE33863643632");
		setArmEnabled(false);
...
this.addEventBehavior(new RPTEventStructure(new RPTFailVPEvent(), new RPTContinueEvent("Content Verification Point failed"), 1, "Content Verification Point failed"));
	...
	this.add(applicationContext_4(this));
			this.addFinally(new EndMoebStepBatchAction(this));
		     ...
		     log("Test Execution: AddMultumAllergy_SplitScreen_Test_A1E5EFF94C5E46A5C2FBE33863643632 ",e);
	    } finally {
	        super.execute();
		}	    
    }
	...
	private DatapoolAction datapool_1(IContainer parent) {
		DatapoolAction dpAction = new DatapoolAction(parent, "A1E60B6844B86BA0E4C8B53064663364", "A1E60B6EAEA44C90E4C8B53064663364");
...
private VariableAction varAction_1(final IContainer parent) {
	...
	VariableAction vc = new VariableAction(parent, "", "A1E5E4EE98B3126EC2FBE33863643632");	
			vars[0] = new DataVar("Var_MultumAllergy", null, IDataArea.VIRTUALUSER, "IGNORE", false, false);
...
private AssignVariableAction dataVarAssign_1(final IContainer parent) {
	AssignVariableAction varAction = new AssignVariableAction(parent, "A1E60D343C691940C1FCE33362383431");
...
private AssignVariableAction dataVarAssign_2(final IContainer parent) {
	...
	ISubRule sub_0 = new SubRule("MOEB_FIELD/TPM:A1E5E4EEA9A7E457C2FBE33863643632", 0, 14, false, (IDCCoreVar)vars[0], false, "Multum Allergy_2", null, 0, false);

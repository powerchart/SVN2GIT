...
public class Test_A1E60D24C1D58C0FC1FCE33362383431 extends LTTestScript  {
...
pa.addPA("com.ibm.rational.test.lt.execution.moeb.dc.MoebDataAdapter", "com.ibm.rational.test.lt.execution.moeb.action.MoebStepBatchAction");
	...
	public Test_A1E60D24C1D58C0FC1FCE33362383431(IContainer container, String invocationId) {
		super(container, "AllergyDetails_Verify_SplitScreen-E", invocationId, "A1E60D24C1D58C0FC1FCE33362383431");
		setArmEnabled(false);
...
this.addEventBehavior(new RPTEventStructure(new RPTFailVPEvent(), new RPTContinueEvent("Content Verification Point failed"), 1, "Content Verification Point failed"));
	...
	this.add(applicationContext_1(this));
			this.addFinally(new EndMoebStepBatchAction(this));
		     ...
		     log("Test Execution: Test_A1E60D24C1D58C0FC1FCE33362383431 ",e);
	    } finally {
	        super.execute();
		}	    
    }
	...
	VariableAction vc = new VariableAction(parent, "", "A1E5ECEBE1AF744EC2FBE33863643632");	
			vars[0] = new DataVar("Var_Status_Value_Proposed_E", "Proposed", IDataArea.VIRTUALUSER, "IGNORE", false, false);

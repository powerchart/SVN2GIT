...
public class Verify_ObviousPINWindow_AfterEntering_1111PIN_intoCreatePINPadScreen_Test_A1E6219D3EFDC8C3CC18B63837636437 extends LTTestScript  {
...
pa.addPA("com.ibm.rational.test.lt.execution.moeb.dc.MoebDataAdapter", "com.ibm.rational.test.lt.execution.moeb.action.MoebStepBatchAction");
	...
	public Verify_ObviousPINWindow_AfterEntering_1111PIN_intoCreatePINPadScreen_Test_A1E6219D3EFDC8C3CC18B63837636437(IContainer container, String invocationId) {
		super(container, "Verify_ObviousPINWindow_AfterEntering_1111PIN_intoCreatePINPadScreen", invocationId, "A1E6219D3EFDC8C3CC18B63837636437");
		setArmEnabled(false);
...
this.addEventBehavior(new RPTEventStructure(new RPTFailVPEvent(), new RPTContinueEvent("Content Verification Point failed"), 1, "Content Verification Point failed"));
	...
	this.addEventBehavior(new RPTEventStructure(new RPTCustomCodeExceptionEvent(), new RPTStopUserEvent("Custom Code reported an unhandled exception"), 1, "Custom Code reported an unhandled exception"));
			...
			this.addFinally(new EndMoebStepBatchAction(this));
		     ...
		     log("Test Execution: Verify_ObviousPINWindow_AfterEntering_1111PIN_intoCreatePINPadScreen_Test_A1E6219D3EFDC8C3CC18B63837636437 ",e);
	    } finally {
	        super.execute();
		}	    
    }

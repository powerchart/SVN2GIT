...
public class ImmunizationSplitView_ClosePopoverManualIPAD_Test_A1E5DCB060ABE126CBFFB83930633666 extends LTTestScript  {
...
pa.addPA("com.ibm.rational.test.lt.execution.moeb.dc.MoebDataAdapter", "com.ibm.rational.test.lt.execution.moeb.action.MoebStepBatchAction");
	...
	public ImmunizationSplitView_ClosePopoverManualIPAD_Test_A1E5DCB060ABE126CBFFB83930633666(IContainer container, String invocationId) {
		super(container, "ImmunizationSplitView_ClosePopoverManualIPAD", invocationId, "A1E5DCB060ABE126CBFFB83930633666");
		setArmEnabled(false);
...
this.addEventBehavior(new RPTEventStructure(new RPTFailVPEvent(), new RPTContinueEvent("Content Verification Point failed"), 1, "Content Verification Point failed"));
	...
	this.addEventBehavior(new RPTEventStructure(new RPTCustomCodeExceptionEvent(), new RPTStopUserEvent("Custom Code reported an unhandled exception"), 1, "Custom Code reported an unhandled exception"));
			...
			this.addFinally(new EndMoebStepBatchAction(this));
		     ...
		     log("Test Execution: ImmunizationSplitView_ClosePopoverManualIPAD_Test_A1E5DCB060ABE126CBFFB83930633666 ",e);
	    } finally {
	        super.execute();
		}	    
    }
	...
	public class CustomCode_1 extends CustomCodeAction {
		...
		public CustomCode_1(IContainer parent, IDataCorrelationVar outVar) {
			super(parent, "closePopover.Class", "A1E5CEAC74423160C17FB13564643936");
			this.outVar = outVar;
		}
		...
		public void execute() {
			...
			ICustomCode2 ccclass = 	new closePopover.Class();

...
public class Folder_NavigateBack_Test_A1E5CC4AB11CABCDD9E8B43733386336 extends LTTestScript  {
...
pa.addPA("com.ibm.rational.test.lt.datacorrelation.execution.protocol.core.CoreProtoAdapter", "coreAdapter");
	...
	public Folder_NavigateBack_Test_A1E5CC4AB11CABCDD9E8B43733386336(IContainer container, String invocationId) {
		super(container, "Folder_NavigateBack", invocationId, "A1E5CC4AB11CABCDD9E8B43733386336");
		setArmEnabled(false);
...
this.addEventBehavior(new RPTEventStructure(new RPTFailVPEvent(), new RPTContinueEvent("Content Verification Point failed"), 1, "Content Verification Point failed"));
	...
	this.add(applicationContext_1(this));
			this.addFinally(new EndMoebStepBatchAction(this));
		     ...
		     log("Test Execution: Folder_NavigateBack_Test_A1E5CC4AB11CABCDD9E8B43733386336 ",e);
	    } finally {
	        super.execute();
		}	    
    }

...
public class AddOrders_SelectOrder_Test_A1E5CC45C7CD7C59D9E8B43733386336 extends LTTestScript  {
...
pa.addPA("com.ibm.rational.test.lt.datacorrelation.execution.protocol.core.CoreProtoAdapter", "coreAdapter");
	...
	public AddOrders_SelectOrder_Test_A1E5CC45C7CD7C59D9E8B43733386336(IContainer container, String invocationId) {
		super(container, "AddOrders_SelectOrder", invocationId, "A1E5CC45C7CD7C59D9E8B43733386336");
		setArmEnabled(false);
...
this.addEventBehavior(new RPTEventStructure(new RPTFailVPEvent(), new RPTContinueEvent("Content Verification Point failed"), 1, "Content Verification Point failed"));
	...
	this.add(applicationContext_1(this));
			this.addFinally(new EndMoebStepBatchAction(this));
		     ...
		     log("Test Execution: AddOrders_SelectOrder_Test_A1E5CC45C7CD7C59D9E8B43733386336 ",e);
	    } finally {
	        super.execute();
		}	    
    }
	...
	VariableAction vc = new VariableAction(parent, "", "A1E5BF90DAFB0D4EDB6FB26232623866");	
		...
		vars[1] = new DataVar("Var_OrderLocation", null, IDataArea.VIRTUALUSER, "WARNING", false, false);

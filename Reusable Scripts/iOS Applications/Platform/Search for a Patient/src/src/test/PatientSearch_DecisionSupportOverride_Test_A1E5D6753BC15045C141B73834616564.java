...
public class PatientSearch_DecisionSupportOverride_Test_A1E5D6753BC15045C141B73834616564 extends LTTestScript  {
...
pa.addPA("com.ibm.rational.test.lt.datacorrelation.execution.protocol.core.CoreProtoAdapter", "coreAdapter");
	...
	public PatientSearch_DecisionSupportOverride_Test_A1E5D6753BC15045C141B73834616564(IContainer container, String invocationId) {
		super(container, "PatientSearch_DecisionSupportOverride", invocationId, "A1E5D6753BC15045C141B73834616564");
		setArmEnabled(false);
...
this.addEventBehavior(new RPTEventStructure(new RPTFailVPEvent(), new RPTContinueEvent("Content Verification Point failed"), 1, "Content Verification Point failed"));
	...
	this.add(ltIf_1(this));
			this.addFinally(new EndMoebStepBatchAction(this));
		     ...
		     log("Test Execution: PatientSearch_DecisionSupportOverride_Test_A1E5D6753BC15045C141B73834616564 ",e);
	    } finally {
	        super.execute();
		}	    
    }

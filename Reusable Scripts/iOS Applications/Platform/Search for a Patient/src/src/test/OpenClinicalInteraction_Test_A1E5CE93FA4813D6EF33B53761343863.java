...
public class OpenClinicalInteraction_Test_A1E5CE93FA4813D6EF33B53761343863 extends LTTestScript  {
...
pa.addPA("com.ibm.rational.test.lt.datacorrelation.execution.protocol.core.CoreProtoAdapter", "coreAdapter");
	...
	public OpenClinicalInteraction_Test_A1E5CE93FA4813D6EF33B53761343863(IContainer container, String invocationId) {
		super(container, "Open clinical interaction", invocationId, "A1E5CE93FA4813D6EF33B53761343863");
		setArmEnabled(false);
...
this.addEventBehavior(new RPTEventStructure(new RPTFailVPEvent(), new RPTContinueEvent("Content Verification Point failed"), 1, "Content Verification Point failed"));
	...
	this.addEventBehavior(new RPTEventStructure(new RPTCustomCodeExceptionEvent(), new RPTStopUserEvent("Custom Code reported an unhandled exception"), 1, "Custom Code reported an unhandled exception"));
			...
			this.addFinally(new EndMoebStepBatchAction(this));
		     ...
		     log("Test Execution: OpenClinicalInteraction_Test_A1E5CE93FA4813D6EF33B53761343863 ",e);
	    } finally {
	        super.execute();
		}	    
    }
